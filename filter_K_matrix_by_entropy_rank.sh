...
#SBATCH --error=log_files/filter_K_matrix_by_entropy_rank.err
#SBATCH --output=log_files/filter_K_matrix_by_entropy_rank.out
...
python filter_K_matrix_by_entropy_rank.py