...
for file in cfDNA_data_filenames:
    ...
    filename = file[file.find('/') + 1 : file.find('.')]
    ...
    log_filename = f"results/logs/{filename}_{K_matrix_filename }_{formatted_datetime}.txt"
...
#%% WRITE OUT RESULTS
cfDNA_data_filenames = 'loyfer_result' #EDIT FOR FINAL
...
results_filename = f"results/{cfDNA_data_filenames}_{K_matrix_config_filename}_{formatted_datetime}.csv"
